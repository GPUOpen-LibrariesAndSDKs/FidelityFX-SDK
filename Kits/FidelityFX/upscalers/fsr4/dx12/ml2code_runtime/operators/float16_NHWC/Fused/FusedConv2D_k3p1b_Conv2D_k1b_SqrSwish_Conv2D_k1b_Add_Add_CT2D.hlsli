...
template<typename SI, typename SW0, typename SB0 ,typename SW1, typename SB1, typename SW2, typename SB2, typename SA, typename SW3, typename SB3, typename SO>
void FusedConv2D_k3p1b_Conv2D_k1b_SqrSwish_Conv2D_k1b_Add_Add_CT2D(
    ...
    const Tensor4h_HWCN<SW3>    ct2d_weights,
